...
export function BottomPlayer() {
  ...
  if (currentLanguage === 'english' && englishQueue && englishQueue.length > 0) {
        ...
        <div className="flex flex-col items-center flex-[2] w-full max-w-md">
          <div className="flex items-center justify-center gap-8 mb-3">
            <button 
              ...
              className={`transition-colors ${hasPrevious ? 'text-neutral-400 dark:text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-100' : 'text-neutral-200 dark:text-neutral-700 cursor-not-allowed'}`}
            >
            ...
            <button 
              onClick={playNext}
              disabled={!hasNext}
              className={`transition-colors ${hasNext ? 'text-neutral-400 dark:text-neutral-500 hover:text-neutral-900 dark:hover:text-neutral-100' : 'text-neutral-200 dark:text-neutral-700 cursor-not-allowed'}`}
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
